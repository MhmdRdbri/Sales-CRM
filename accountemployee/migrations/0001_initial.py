# Generated by Django 5.0.6 on 2024-10-27 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accountemployee.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='accountemployee.customuser')),
            ],
        ),
    ]
